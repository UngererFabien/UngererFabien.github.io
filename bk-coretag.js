/* 3.0.24-96091 */ ! function() {
    function createCookie(a, b, c) {
        var d = new Date,
            e = c ? d.getTime() + 86400000 * c : d.getTime(),
            f = [];
    ...
    ! function(a) {
    ...
    }(), define("../vendor/almond", function() {}), "object" != typeof JSON && (JSON = {}),
        function() {
            function f(a) {
                return 10 > a ? "0" + a : a;
            }
            ...
            var a = function(a) {
                ...
                b = {
                    ...
                    htmlToDom: function(a, c) {
                        var d = [],
                            e = c.documentElement || c.getOwnerDocument && c.getOwnerDocument() || c;
                        if (!e && c.createElement && function() {
                                var a = c.createElement("html"),
                                    b = c.createElement("head");
            ...
            var c = {
                ...
                isMobile: function() {
                    var a = !1,
                        b = ["Mobile", "Tablet", "Handheld", "Android", "iPhone", "Kindle", "Silk", "Nokia", "Symbian", "BlackBerry"];
                    for (var c in b) {
        ...
        }), define("../vendor/cookies", function() {}), define("../vendor/numis", [], function() {
            var a = {
                    java: function(a) {
            ...
            function r(a, b) {
                var c, d, e, f, g, h, i, j, k, r, t, u, v = new Array(1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225),
                    x = new Array(64);
            ...
            return b.prototype = {
                ...
                getCanvasFingerprint: function() {
                    var a = document.createElement("canvas"),
                        b = a.getContext("2d"),
                        c = "Mr. Jock, TV quiz Ph-D, bags few lynx!",
                        d = "Ù©(Í¡à¹Ì¯Í¡à¹)Û¶Ù©(-Ì®Ì®Ìƒâ€¢Ìƒ)Û¶Ù©(Ì¾â—Ì®Ì®ÌƒÌ¾â€¢ÌƒÌ¾)Û¶Ù©(-Ì®Ì®Ìƒ-Ìƒ)Û¶(Í¡Â°ÍœÊ–Í¡Â°)";
                ...
                l = {
                    ...
                    doTag: function(c, e, f, g, m, n, o, p, q) {
                        ...
                        if (!(r.suppressMultipleCalls === !0 || "undefined" != typeof i && i && r.allowMultipleCalls !== !0)) {
                            ...
                            var y = "https://stags.bluekai.com/",
                                z = "http://tags.bluekai.com/",
                                A = ("https:" === document.location.protocol ? r.pixelSecure ? r.pixelSecure : y : r.pixelUrl ? r.pixelUrl : z) + (u ? "psite" : "site") + "/" + r.site,
                                B = A + "?" + h.join("&");
